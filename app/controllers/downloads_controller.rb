class DownloadsController < ApplicationController
  ...
  def create
    ...
    file_name = "#{Rails.root}/tmp/#{rand(100000)}_%(title)s.%(ext)s"
    YoutubeDL.download params[:url], { "restrict_filenames" => nil, "add_metadata" => nil, "extract_audio" => nil, "audio_format" => "mp3", output: file_name}

    @download = Download.new(file_location: file_name)
